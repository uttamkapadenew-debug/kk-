...
function confirmDialog(message, onConfirm) {
  ...
  const resetBtn = () => { save.style.background = ''; save.style.boxShadow = ''; };
  cancel.addEventListener('click', resetBtn, { once: true });
  document.getElementById('modalClose').addEventListener('click', resetBtn, { once: true });
  document.getElementById('modalOverlay').classList.add('open');
}
